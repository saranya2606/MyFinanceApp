...
class ParticipantsAdapter(private val participants: List<selectedPeople>) :
    ...
    override fun onBindViewHolder(holder: ParticipantViewHolder, position: Int) {
        ...
        holder.textViewParticipantName.text = participant.username
    }
    ...
    inner class ParticipantViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val textViewParticipantName: TextView = itemView.findViewById(R.id.textViewParticipantName)
    }
}
